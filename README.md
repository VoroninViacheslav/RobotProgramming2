...
Симуляция трехзвенного мобильного манипулятора в MuJoCo с PD-контроллером для задачи pick-and-place. Симулятор и контроллер работают в отдельных процессах и обмениваются данными через ZeroMQ (REQ/REP).
